{
 "cells": [
  ...
  },
  {
   ...
   "source": [
    "df = pd.read_csv('/Users/heechul/Downloads/파이썬 통계적분석 자료/data/ch2_scores_em.csv',\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "/var/folders/fp/kmjp52ws5099plpj2fv8zsyh0000gn/T/ipykernel_43451/1381989562.py:3: MatplotlibDeprecationWarning: The 'labels' parameter of boxplot() has been renamed 'tick_labels' since Matplotlib 3.9; support for the old name will be dropped in 3.11.\n",
